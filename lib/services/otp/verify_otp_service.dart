...
class VerifyOTPService {
  ...
  Future<Map<String, dynamic>> verifyOTP(String otp) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://fluttbizitsolutions.com/api/bheseb_verify.php'),
        body: data,
      );
  ...
  Future<Map<String, dynamic>> verifyOTPMonthly(String otp) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    final referenceNumber = sharedPreferences.getString("REFERENCE_NUMBER");
    ...
    try {
      final response = await http.post(
        Uri.parse('https://fluttbizitsolutions.com/api/heseb_verify.php'),
        body: data,
      );
