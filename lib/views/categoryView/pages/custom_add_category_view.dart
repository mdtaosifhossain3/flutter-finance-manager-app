...
// import 'package:finance_manager_app/models/categoryModel/category_data_model.dart';
...
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Text('Category Type *', style: Theme.of(context).textTheme.bodyMedium),
//         SizedBox(height: 12),
//         Container(
...
//             validator: (value) {
//               if (!isCustomGroup &&
//                   (value == null || value.isEmpty || value == 'create_new')) {
...
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Text('Select Icon *', style: Theme.of(context).textTheme.bodyMedium),
//         SizedBox(height: 12),
//         Container(
//           height: 200,
...
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         Text('Select Color *', style: Theme.of(context).textTheme.bodyMedium),
//         SizedBox(height: 12),
//         Container(
//           padding: EdgeInsets.all(16),
//           decoration: BoxDecoration(
